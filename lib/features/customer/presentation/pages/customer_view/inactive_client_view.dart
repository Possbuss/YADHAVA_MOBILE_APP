...
class InActiveClientListScreen extends StatefulWidget {
  const InActiveClientListScreen({super.key});

  @override
  State<InActiveClientListScreen> createState() =>
      _InActiveClientListScreenState();
}

class _InActiveClientListScreenState extends State<InActiveClientListScreen> {
  ...
  void initState() {
    super.initState();
    context.read<ClientListBloc>().add(const GetInActiveClientListEvent());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Inactive Clients'),
        centerTitle: true,
        actions: [
          IconButton(
            ...
            onPressed: () {
              ...
              context
                  .read<ClientListBloc>()
                  .add(const GetInActiveClientListEvent(forceRefresh: true));
            },
          ),
        ],
      ),
      body: BlocBuilder<ClientListBloc, ClientListState>(
        builder: (context, state) {
          if (state is ClientListInActiveLoading) {
            return const Center(child: CircularProgressIndicator());
          }

          if (state is ClientListInActiveLoaded) {
