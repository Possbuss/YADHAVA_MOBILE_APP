...
class InActiveClientListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            icon: const Icon(Icons.sync, color: Colour.darkgrey),
            onPressed: () {
              // 🔄 Trigger refresh (call your event)
              context.read<ClientListBloc>().add(GetInActiveClientListEvent());
            },
          ),
        ],
      ),
