...
class cashTableRow extends StatelessWidget {
  const cashTableRow({super.key});
      ...
      child: BlocBuilder<HomeBloc, HomeState>(
        builder: (context, state) {
          if (state is HomeStateLoading) {
            ...
            final cashList = state.homeData?.mobileAppSalesCash;
            if (cashList == null) {
              return const Center(
                child: Text(
                  "No records found",
                            ...
                            Padding(
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                      flex: 2,
                                      child: Text(cashItem.customerAccountName,
                                          style: const TextStyle(
                                              color: Colour.mediumGray,
                                              fontWeight: FontWeight.bold))),
                                  Expanded(
                                      flex: 2,
                                      child: Text(cashItem.payType,
                                          style: const TextStyle(
                                              color: Colour.mediumGray,
                                              fontWeight: FontWeight.bold))),
                                  Expanded(
