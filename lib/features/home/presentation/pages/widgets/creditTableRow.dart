...
class creditTableRow extends StatelessWidget {
  const creditTableRow({super.key});
      ...
      child: BlocBuilder<HomeBloc, HomeState>(
        builder: (context, state) {
          if (state is HomeStateLoading) {
            ...
            final creditList = state.homeData?.mobileAppSalesCredit;
            if (creditList == null) {
              return const Center(
                child: Text(
                  "No records found",
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        final creditItem = creditList?[index];
                        return Column(
                          children: [
                            Padding(
                              padding:
                              ...
                              child: Row(
                                children: [
                                  Expanded(
                                      flex: 2,
                                      child: Text(
                                          creditItem!.customerAccountName,
